  ...
  <div class="products-page">
    ...
    <div class="filter-bar">
      <div class="filter-options">
        <el-select v-model="selectedCategory" @change="loadProducts" placeholder="选择分类" clearable>
        ...
        <el-select v-model="priceRange" @change="loadProducts" placeholder="价格区间" clearable>
...
import { getProductList, getCategoryList, type Product, type Category } from '@/api/user/product'
