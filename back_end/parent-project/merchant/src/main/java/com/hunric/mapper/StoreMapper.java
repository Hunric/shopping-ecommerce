...
public interface StoreMapper {
    ...
    @Select("SELECT store_id, merchant_id, store_name, store_logo, store_description, " +
            "open_time, status, credit_score, create_time, update_time " +
    ...
    List<Store> selectByMerchantId(@Param("merchantId") Integer merchantId);
     ...
     * @return 影响行数
     */
    @Insert("INSERT INTO store_info (merchant_id, store_name, store_logo, store_description, " +
            "open_time, status, credit_score) " +
            "VALUES (#{merchantId}, #{storeName}, #{storeLogo}, #{storeDescription}, " +
            "#{openTime}, #{status}, #{creditScore})")
